...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "مستر فرايز — قائمة الطعام الإلكترونية" },
      {
        name: "description",
        content: "مستر فرايز — استمتع بتجربة طلب عصرية وسريعة من قائمة طعام إلكترونية أنيقة",
      },
      { property: "og:title", content: "مستر فرايز — قائمة الطعام الإلكترونية" },
      {
      ...
      { name: "twitter:title", content: "مستر فرايز — قائمة الطعام الإلكترونية" },
      { name: "twitter:description", content: "مستر فرايز — استمتع بتجربة طلب عصرية وسريعة من قائمة طعام إلكترونية أنيقة" },
